...
//var Connector = require('../../../../../api/deployments/springcdf/springcdf.connector')
//
...
//
//
//describe('springcdf.connector', function() {
//	
//	
//	var recorder = record('springcdf.connector', { 'fixtures': __dirname + '../../../../../fixtures' });
//	var springxd = new Connector("scd-admin-k8s." + process.env.RIOX_ENV + ".svc.cluster.local", 9393);
//
