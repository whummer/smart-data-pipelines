...
envs.forEach(function(env) {
	appConfig[env] = {
			...
			services: {
				...
				pipeelements: {		url: "http://" + getHost(env, "pipes-service") + ":8085/api/v1/pipeelements" },
				pipedeployments: {		url: "http://" + getHost(env, "pipes-service") + ":8085/api/v1/pipes/deployments" }, 
