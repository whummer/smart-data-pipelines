...
public class TestValueDomain {
	...
	public void testDomainGeneration() {
		ValueDomain<Double> d1 = new ValueDomain.DiscreteVD<Double>(-30.0, 50.0, 0.1);
		testDomainSize(d1, 800L);

		ValueDomain<Double> d2 = new ValueDomain.DiscreteVD<Double>(-30.0, 50.0, 0.03);
		testDomainSize(d2, 2667L);

		ValueDomain<Double> d3 = new ValueDomain.ContinuousVD<Double>(-30.0, 50.0);
		testDomainSize(d3, null);

		Double[] v1 = new Double[]{-30.0, 50.0, 0.1, 31.2, 123124.3, 123123.4};
		ValueDomain<Double> d4 = new ValueDomain.EnumerationVD<Double>(v1);
