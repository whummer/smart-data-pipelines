...
var demoData = [
	...
	"including location, fuel level." + LOREM,
		organizationImg: "app/components/img/provider-logos/bmw.png", organizationName: "BMW",
	...
	"including location, fuel level." + LOREM,
		organizationImg: "app/components/img/provider-logos/tesla.png", organizationName: "TESLA",
	...
	"including location, fuel level." + LOREM,
		organizationImg: "app/components/img/provider-logos/mercedes.gif", organizationName: "Mercedes",
	...
	"including location, fuel level." + LOREM,
		organizationImg: "app/components/img/provider-logos/toyota.png", organizationName: "Toyota",
		price: {type: "per_event", amount: 0.0018}, permit: {type: "auto"}
	},
	{
		id: 8, name: "Smart Building Data", description: "This data stream contains " +
	"live about smart buildings." + LOREM,
		organizationImg: "app/components/img/provider-logos/energieeffizienz.jpg", organizationName: "Energieeffizienz",
