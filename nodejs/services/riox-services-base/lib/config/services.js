...
envs.forEach(function(env) {
	appConfig[env] = {
			...
			services: {
				...
				streamprocessors: {	url: "http://" + getHost(env, "streams-service") + ":8085/api/v1/streams/processors" },
				access: {			url: "http://" + getHost(env, "access-service") + ":8085/api/v1/access" },
				consents: {			url: "http://" + getHost(env, "consent-service") + ":8085/api/v1/consents" },
				...
				ratings: {			url: "http://" + getHost(env, "ratings-service") + ":8085/api/v1/ratings" },
				statistics: {		url: "http://" + getHost(env, "statistics-service") + ":8085/api/v1/statistics" },
