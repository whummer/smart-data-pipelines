 ...
 */
public class ValueDomainDiscreteElastic<T> extends ValueDomainContinuousElastic<T> {
	T step;
	public ValueDomainDiscreteElastic() {
		this(null, null, null);
	}
	public ValueDomainDiscreteElastic(T min, T max, T step) {
		super(min, max);
		this.step = step;
