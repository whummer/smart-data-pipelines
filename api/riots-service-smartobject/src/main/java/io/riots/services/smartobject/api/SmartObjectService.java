//package io.riots.services.smartobject.api;
//
//import java.net.URI;
//
//import javax.ws.rs.*;
...
//
////import io.riots.core.handlers.command.SmartObjectRepositoryCommands;
//import io.riots.core.handlers.query.Paged;
//import io.riots.core.handlers.query.SmartObjectRepositoryQueries;
//import io.riots.core.mapping.RestObjectMapper;
...
//
//    @Autowired
//    private RestObjectMapper<SmartObject, io.riots.core.repositories.domain.SmartObject> mapper;
//
//    @GET
//    @Path("/{id}")
...
////        //io.riots.core.repositories.domain.SmartObject domainObject = commands.create(
////                mapper.map(smo, io.riots.core.repositories.domain.SmartObject.class));
////
