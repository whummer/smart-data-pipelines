...
public class CORSFilter implements Filter {
	...
	public static final String HEADER_AUTH_NETWORK = "riot-auth-network";
	public static final String HEADER_AUTH_EMAIL = "riot-auth-email";
	public static final String HEADER_AUTH_USERID = "riot-auth-userid";
	public static final String HEADER_AUTH_TOKEN = "riot-auth-token";
