...
public interface SimulationService {
	...
	List<Simulation> listSimulations(@QueryParam("thingId") String thingId, @QueryParam("propertyName") String
			propertyName, @QueryParam("page") int page, @QueryParam("size") int size);
