...
define(
		...
		function (config) {
			...
			// om ugly hack for ZeroClipboard
			// http://stackoverflow.com/questions/25358897/zeroclipboard-and-requirejs-zeroclipboard-is-not-defined
/*			app.directive('clipCopy', ['$window', function ($window) {
				return {
					scope: {
						clipCopy: '&',
						clipClick: '&'
			...
			app.config([
				...
				function ($routeProvider, $locationProvider, $controllerProvider,
									$compileProvider, $filterProvider, $httpProvider, $animateProvider, $provide, ngClipProvider) {
					...
					//ngClipProvider.setPath("scripts/ext/zeroclipboard/ZeroClipboard.swf");
