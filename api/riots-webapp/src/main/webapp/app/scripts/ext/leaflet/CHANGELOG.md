 ...
 * Added **Canvas backend** for vector layers (polylines, polygons, circles). This enables vector support on Android < 3, and it can also be optionally preferred over SVG for a performance gain in some cases. Thanks to [@rioxf](https://github.com/rioxf) for a big part of this work.
 ...
 * Fixed crash on Android 3+ when panning or zooming (by [@riox](https://github.com/rioxf)). [#137](https://github.com/Leaflet/Leaflet/issues/137)
