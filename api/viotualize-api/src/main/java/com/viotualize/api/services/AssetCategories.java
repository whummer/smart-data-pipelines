...
import com.viotualize.api.handlers.command.AssetCategoryCommand;
import com.viotualize.api.handlers.query.AssetCategoryQuery;
...
public class AssetCategories {
    ...
    public Response create(AssetCategory entity) {
        ...
        return Response.created(UriBuilder.fromMethod(
        		AssetCategories.class, "retrieve").build(entity.getId())).build();
    }
