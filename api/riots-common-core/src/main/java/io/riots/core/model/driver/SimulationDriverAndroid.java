...
public class SimulationDriverAndroid implements SimulationDriver {
	...
	public static void main(String[] args) {
		...
		/* LOCATION */
		Property<Double> pLat = new Property.PropertyDouble();
		Property<Double> pLon = new Property.PropertyDouble();
		Property<List<?>> pLoc = new Property.PropertyList();
		pLoc.setSemanticType(new SemanticPropertyType(PredefinedPropTypes.location.toString()));
		pLat.setSemanticType(new SemanticPropertyType(PredefinedPropTypes.location_lat.toString()));
		pLon.setSemanticType(new SemanticPropertyType(PredefinedPropTypes.location_lon.toString()));
		...
		Property<Double> pPow = new Property.PropertyDouble();
