...
/**
 * This interface is implemented by classes defining methods
 * protected with {@link PreAuthorize} annotations. Note that
 * this interface is identical to {@link PermissionEvaluator}, 
 * however, there seems to be an issue with Spring AOP loading if 
 * multiple implementations of {@link PermissionEvaluator} are 
 * found in the classpath.
 * @author whummer
 */
public interface AuthPermissionEvaluator {
	/**
    *
