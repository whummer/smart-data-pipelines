...
// */
//
//public class EurekaPortAdvisor implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
//
//    static final Logger log = LoggerFactory.getLogger(EurekaPortAdvisor.class);
//
//    @Override
