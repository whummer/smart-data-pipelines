...
public class EmailSender {
	...
	public static final String EMAIL_TEST_FROM = "test@riots.io";
	public static final String EMAIL_TEST_USER = "test@riots.io";
	public static final String EMAIL_TEST_PASS = "__TODO__";

	public static final String EMAIL_IMAP_HOST = "mail.gandi.net";
	...
	public static void send(String to, String subject, String message) {
		send(to, subject, message, EMAIL_FROM, EMAIL_USER, EMAIL_PASS);
	}
	...
	public static List<Message> getEmailsForTestAccount(boolean onlyUnread) throws MessagingException, IOException {
		return getEmailsIMAP(EMAIL_IMAP_HOST, EMAIL_TEST_USER, EMAIL_TEST_PASS, onlyUnread);
	}
	...
	public static List<Message> deleteEmailsForTestAccount(boolean onlyUnread) 
			throws MessagingException, IOException {
		return deleteEmails(EMAIL_IMAP_HOST, EMAIL_TEST_USER, EMAIL_TEST_PASS, onlyUnread);
	}
