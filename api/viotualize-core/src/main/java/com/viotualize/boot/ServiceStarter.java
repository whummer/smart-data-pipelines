...
@EnableMongoRepositories(basePackages = { "com.viotualize.core.repositories" }, excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = "com\\.viotualize\\.core\\.repositories\\.BaseObjectRepository"))
@Configuration
@ComponentScan(basePackages = { "com.viotualize" })
@ImportResource(value = { "classpath*:/cxf-config.xml" })
@EnableMetrics
// todo om: register JVM metrics
public abstract class ServiceStarter { // extends AbstractCloudConfig {
	...
	public ServletListenerRegistrationBean<KaryonGuiceContextListener> karyonListner() {
		return new ServletListenerRegistrationBean<KaryonGuiceContextListener>(new KaryonGuiceContextListener());
	}
...
//		return new ServletRegistrationBean(new MetricsServlet(metricRegistry),
//				"/codahale-metrics");
//	}
...
//	}
	...
	/*
	 * @Bean public MongoDbFactory mongoDbFactory() { return
	 * connectionFactory().mongoDbFactory("viotualize"); }
	 * @Bean public Properties cloudProperties() { return properties(); }
	 */
