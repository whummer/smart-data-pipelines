...
import com.viotualize.core.scripting.VariableWrapper;
 ...
 *
 * Patched by Waldemar Hummer (see "whu" comments below).
 *
...
public class ScriptBytecodeAdapter {
    ...
    public static boolean compareIdentical(Object left, Object right) {
        /* begin whu */
    	if(left instanceof VariableWrapper || right instanceof VariableWrapper) {
    		VariableWrapper.compareIdentical(left, right);
    	}
        /* end whu */
        return left == right;
    }
    ...
    public static boolean compareNotIdentical(Object left, Object right) {
        /* begin whu */
    	if(left instanceof VariableWrapper || right instanceof VariableWrapper) {
    		VariableWrapper.compareNotIdentical(left, right);
    	}
        /* end whu */
        return left != right;
    }
    ...
    public static boolean compareLessThan(Object left, Object right) {
        /* begin whu */
    	if(left instanceof VariableWrapper || right instanceof VariableWrapper) {
    		VariableWrapper.compareLessThan(left, right);
    	}
        /* end whu */
    ...
    public static boolean compareLessThanEqual(Object left, Object right) {
        /* begin whu */
    	if(left instanceof VariableWrapper || right instanceof VariableWrapper) {
    		VariableWrapper.compareLessThanEqual(left, right);
    	}
        /* end whu */
        return compareTo(left, right).intValue() <= 0;
    }
    ...
    public static boolean compareGreaterThan(Object left, Object right) {
        /* begin whu */
    	if(left instanceof VariableWrapper || right instanceof VariableWrapper) {
    		VariableWrapper.compareGreaterThan(left, right);
    	}
        /* end whu */
        return compareTo(left, right).intValue() > 0;
    }
    ...
    public static boolean compareGreaterThanEqual(Object left, Object right) {
        /* begin whu */
    	if(left instanceof VariableWrapper || right instanceof VariableWrapper) {
    		VariableWrapper.compareGreaterThanEqual(left, right);
    	}
        /* end whu */
        return compareTo(left, right).intValue() >= 0;
    }
