  ...
  <body id="one">
    ...
    <div class="container-fluid xd-container">
      ...
      <table id='instances' class="table table-striped table-hover">
        <thead>
          <tr><th>Application</th><th>AMIs</th><th>Availability Zones</th><th>Health</th><th>Insights</th></tr>
        </thead>
        <tbody>
          <#if apps?has_content>
            <#list apps as app>
              <tr>
                ...
                <td>
                  <#list app.instanceInfos as instanceInfo>
                    ...
                    <b><div class="label label-success">${instanceInfo.status}</div> (${instanceInfo.instances?size}) -
                    <#if instanceInfo.isNotUp>
                      </b></font>
                    </#if>
