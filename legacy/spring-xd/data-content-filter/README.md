Spring XD RxJava Stream Example
===============================
...
The uber-jar will be in `[project build dir]/analytics-moving-average-1.0.0.BUILD-SNAPSHOT.jar`. To install and register the module to your Spring XD distribution, use the `module upload` Spring XD shell command. Start Spring XD and the shell:
	...
	xd:>module upload --file [path-to]/analytics-moving-average-1.0.0.BUILD-SNAPSHOT.jar --name analytics-moving-average --type processor
	Successfully uploaded module 'processor:analytics-moving-average'
	xd:>

Now create an deploy a stream:

```
xd:>stream create rxjava --definition "http | analytics-moving-average --inputType=application/x-xd-tuple | log" --deploy
```
