...
import io.riots.boot.starters.DefaultRiotsRegistry;
...
@SpringApplicationConfiguration(classes = DefaultRiotsRegistry.class)
@WebAppConfiguration
@IntegrationTest("server.port=0")
public class DefaultRiotsRegistryTest {
